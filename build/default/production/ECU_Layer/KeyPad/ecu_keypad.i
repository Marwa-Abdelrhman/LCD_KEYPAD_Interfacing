...
static const uint8 keypad_buttons[4][4]={
                                                                {'7','8','9','/'},
                                                                {'4','5','6','*'},
                                                                {'1','2','3','-'},
                                                                {'#','0','=','+'}
                                                               };
# 28 "ECU_Layer/KeyPad/ecu_keypad.c"
Std_RetrunType keypad_init(const keypad_t *keypad_obj){
    Std_RetrunType ret=((Std_RetrunType) 0x00);
    uint8 row_count=0,column_count=0;
...
Std_RetrunType keypad_get_key_pressed(const keypad_t *keypad_obj,uint8 *value){
    Std_RetrunType ret=((Std_RetrunType) 0x00);
     uint8 l_row_count=0,l_column_count=0,l_count=0;
     uint8 col_pin_state=0;
     uint8 num=0;
    if((((void*)0) == keypad_obj) || (value == ((void*)0)))
    {
        ret=((Std_RetrunType) 0x00);
    }
    else
    {
        ...
        for(l_row_count=0;l_row_count<4;l_row_count++)
        {
           ...
           for(l_column_count=0;l_column_count<4;l_column_count++)
            {
